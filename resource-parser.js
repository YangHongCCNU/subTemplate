/** 
#Quantumult X 资源解析器 (2021-02-18: 14:10)
...
var Pout0="续费|网址|试用|公益|回国|用户群|订阅|无限流量".split("|");
var Pemoji=2;
...
function emoji_handle(servers,Pemoji){
	...
	for(var i=0;i<ser0.length; i++){
		...
		var Lmoji={"🇦🇨": ["AC"],"🇦🇹": ["奥地利","维也纳"],"🇦🇺": ["Australia","Sydney","澳大利亚","澳洲","墨尔本","悉尼"],"🇧🇪": ["比利时"],"🇧🇬️": ["保加利亚"],"🇧🇷": ["Brazil","巴西","圣保罗"],"🇨🇦": ["Canada","Waterloo","加拿大","蒙特利尔","温哥华","楓葉","枫叶","滑铁卢","多伦多"],"🇨🇭": ["瑞士","苏黎世"],"🇩🇪": ["German","GERMAN","德国","德國","法兰克福"],"🇩🇰": ["丹麦"],"🇫🇮": ["Finland","芬兰","赫尔辛基"],"🇫🇷": ["France","法国","法國","巴黎"],"🇬🇧": ["UK","England","United Kingdom","英国","伦敦","英"],"🇲🇴": ["Macao","澳门","CTM"],"🇭🇰": ["HK","Hongkong","Hong Kong","香港","深港","沪港","呼港","HKT","HKBN","HGC","WTT","CMI","穗港","京港","港"],"🇮🇩": ["Indonesia","印尼","印度尼西亚","雅加达"],"🇮🇪": ["Ireland","爱尔兰","都柏林"],"🇮🇳": ["India","印度","孟买","Mumbai"],"🇮🇹": ["Italy","Nachash","意大利","米兰","義大利"],"🇯🇵": ["JP","Japan","日","东京","大阪","埼玉"],"🇰🇵": ["朝鲜"],"🇰🇷": ["Korea","KOR", "KR","韩国","首尔","韩","韓"],"🇲🇽️": ["墨西哥"],"🇲🇾": ["Malaysia","马来西亚","吉隆坡"],"🇳🇱": ["Netherlands","荷兰","荷蘭","尼德蘭","阿姆斯特丹"],"🇵🇭": ["Philippines","菲律宾"],"🇷🇴": ["罗马尼亚"],"🇷🇺": ["Russia","俄罗斯","俄羅斯","伯力","莫斯科","圣彼得堡","西伯利亚","新西伯利亚","京俄","杭俄"],"🇸🇦": ["沙特","迪拜"],"🇸🇪": ["Sweden"],"🇸🇬": ["Singapore", "SGP","新加坡","狮城","沪新","京新","泉新","穗新","深新","杭新","广新"],"🇹🇭": ["Thailand","泰国","泰國","曼谷"],"🇹🇷": ["Turkey","土耳其","伊斯坦布尔"],"🇹🇼": ["Taiwan","TW","台湾","台北","台中","新北","彰化","CHT","台","HINET"],"🇺🇸": ["USA","America","United States","美国","美","京美","波特兰","达拉斯","俄勒冈","凤凰城","费利蒙","硅谷","矽谷","拉斯维加斯","洛杉矶","圣何塞","圣克拉拉","西雅图","芝加哥","沪美","哥伦布","纽约"],"🇻🇳": ["VN","越南","胡志明市"],"🇿🇦":["South Africa","南非"],"🇦🇪":["United Arab Emirates","阿联酋"],"🇦🇷": ["阿根廷"],"🇨🇳": ["China","回国","back","PVCC"]}
		if(Pemoji==1) { 
